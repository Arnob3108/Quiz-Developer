...
const SingleQuiz = ({ allQuestion }) => {
  ...
  return (
    <div
      data-aos="zoom-in-up"
      className="lg:w-3/4 w-80 mx-auto border-2 lg:p-10 p-5 rounded-2xl my-5 lg:m-10 bg-gradient-to-bl from-slate-900 via-purple-900 to-slate-900 hover:shadow-xl hover:shadow-purple-400/70"
    >
